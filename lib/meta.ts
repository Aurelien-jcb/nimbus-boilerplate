...
const domain = "https://aurelienjacob.fr";

export default function meta({
  title,
  description,
  openGraphImage,
  author = "Aurelien Jacob",
  ...props
}: Props & Metadata) {
  return {
    title,
    ...
    generator: "Next.js",
    applicationName: "NextAuthBoilerplate",
